...
const Desc = () => {
  return (
    <section className="bg-primary text-primary-foreground py-32 flex flex-col items-center justify-center px-[1rem]">
      ...
      <div className=" text-[18px] md:text-2xl text-center max-w-4xl leading-relaxed">
        <p>
