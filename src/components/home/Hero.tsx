    ...
    <section className="relative bg-linear-to-br from-teal-50 to-orange-50 py-32">
      <div className=" xl:container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center justify-center">
          <div className="">
            {/* <div className=" bg-secondary/10 text-secondary px-4 py-2 rounded-full text-[14px] sm:text-sm mb-6 w-fit capitalize">
              Registered Health & Certified Menopause Coach
            </div> */}
            <h1 className=" text-[30px] sm:text-5xl xl:text-6xl mb-6 text-teal-900">
              Wellbeing and Midlife Support for Women
            </h1>
            <p className=" text-[16px] sm:text-xl text-gray-700 mb-8 leading-relaxed">
          ...
          <div className="grid place-items-center lg:place-items-end">
            <div className="relative max-w-[500px] ">
              ...
              <div className="max-w-[500px] sm:w-[450px] h-125 overflow-hidden">
                <img
